#ifndef MY_MICRO_CONTEXT_H_
#define MY_MICRO_CONTEXT_H_
#include <cstdint>
...
class MyMicroContext : public MicroContext {
 public:
  ...
  MyMicroContext(MicroAllocator* allocator, const Model* model,
                          MicroInterpreterGraph* graph, TfLiteTensor* tensor);
  virtual ~MyMicroContext();
